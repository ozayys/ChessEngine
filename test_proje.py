...
def test_tahta_olusturma():
    ...
    try:
        ...
        if tahta.tas_turu_al(3) == ('beyaz', 'vezir'):
            print("✓ d1'de beyaz vezir var")
        else:
            print("✗ d1'de beyaz vezir yok")
            return False
        ...
        if tahta.tas_turu_al(59) == ('siyah', 'vezir'):
            print("✓ d8'de siyah vezir var")
        else:
            print("✗ d8'de siyah vezir yok")
            return False
